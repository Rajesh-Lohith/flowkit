...
class VisitorByChannelsModel extends IdentifierModel {
  ...
  static VisitorByChannelsModel fromJSON(Map<String, dynamic> json) {
    ...
    return VisitorByChannelsModel(decoder.getId, channel, session,
        targetReached, bounceRate, pagePerSession, sessionDuration);
  }
  ...
  static Future<String> getData() async {
    return await rootBundle
        .loadString('assets/data/visitors_by_channels_data.json');
  }
}
